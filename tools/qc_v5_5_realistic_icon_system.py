...
if app_version.get("version") != "v5.5-realistic-icon-system":
    errors.append("app_version.json is not aligned to v5.5")
...
if 'APP_VERSION = "v5.5-realistic-icon-system"' not in app_text:
    errors.append("app.py version string is not aligned to v5.5")
