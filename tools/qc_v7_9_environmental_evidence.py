...
def fixture():
    return {
        ...
        "hourly": {"time": [f"2026-09-02T{h:02d}:00-05:00" for h in range(0, 13)], "temperature_2m": [22 + h * .2 for h in range(13)], "pressure_msl": [1015 - h * .4 for h in range(13)], "rain": [0.1] * 13, "precipitation": [0.1] * 13},
