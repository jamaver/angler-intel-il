...
def main() -> int:
    ...
    parser.add_argument("--domain", required=True, choices=("target_profile", "gear_inventory"))
    ...
    if args.domain == "target_profile":
        ...
        result = mirror_gear_inventory(inventory, source_path, db_path=args.db) if args.db else mirror_gear_inventory(inventory, source_path)
